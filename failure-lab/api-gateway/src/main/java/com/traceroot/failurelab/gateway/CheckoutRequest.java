...
public class CheckoutRequest {
    ...
    public boolean isSimulatePaymentRetryStorm() { return simulatePaymentRetryStorm; }
    public void setSimulatePaymentRetryStorm(boolean simulatePaymentRetryStorm) { this.simulatePaymentRetryStorm = simulatePaymentRetryStorm; }
}